					...
					$style_formats = (array) apply_filters( 'wmhook_wm_custom_mce_format', array(
							...
							// Group: Text styles
								...
								100 . 'text_styles' => array(
									'title' => esc_html__( 'Text styles', 'glamour' ),
									'items' => array(

										100 . 'text_styles' . 100 => array(
											'title'    => __( 'Dropcap text', 'glamour' ),
											'selector' => 'p',
											'classes'  => 'dropcap-text',
										),

										100 . 'text_styles' . 110 => array(
											'title'    => esc_html__( 'Uppercase heading or paragraph', 'glamour' ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'uppercase',
										),

										100 . 'text_styles' . 120 => array(
											'title'  => esc_html__( 'Highlighted (marked) text', 'glamour' ),
											'inline' => 'mark',
											'icon'   => 'backcolor',
										),

										100 . 'text_styles' . 130 => array(
											'title'  => esc_html__( 'Small text', 'glamour' ),
											'inline' => 'small',
										),

										100 . 'text_styles' . 140 => array(
											'title'  => esc_html__( 'Superscript', 'glamour' ),
											'icon'   => 'superscript',
											'format' => 'superscript',
										),

										100 . 'text_styles' . 150 => array(
											'title'  => esc_html__( 'Subscript', 'glamour' ),
											'icon'   => 'subscript',
											'format' => 'subscript',
										),

										100 . 'text_styles' . 160 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'glamour' ), 1 ),
											'selector' => 'h2, h3, h4, h5, h6, p',
											'classes'  => 'h1',
										),

										100 . 'text_styles' . 170 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'glamour' ), 2 ),
											'selector' => 'h1, h3, h4, h5, h6, p',
											'classes'  => 'h2',
										),

										100 . 'text_styles' . 180 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'glamour' ), 3 ),
							...
							// Group: Text size
								...
								200 . 'text_sizes' => array(
									'title' => esc_html__( 'Text sizes', 'glamour' ),
									'items' => array(

										200 . 'text_sizes' . 100 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'glamour' ), 1 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-1',
										),

										200 . 'text_sizes' . 110 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'glamour' ), 2 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-2',
										),

										200 . 'text_sizes' . 120 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'glamour' ), 3 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-3',
										),

										200 . 'text_sizes' . 130 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'glamour' ), 4 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-4',
										),
							...
							// Group: Quotes
								...
								300 . 'quotes' => array(
									'title' => esc_html_x( 'Quotes', 'Visual editor blockquote formats group title.', 'glamour' ),
									'items' => array(

										300 . 'quotes' . 100 => array(
											'title' => esc_html__( 'Blockquote', 'glamour' ),
											'block' => 'blockquote',
											'icon'  => 'blockquote',
										),

										300 . 'quotes' . 110 => array(
											'title'   => esc_html__( 'Pullquote - align left', 'glamour' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 120 => array(
											'title'   => esc_html__( 'Pullquote - align right', 'glamour' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 130 => array(
											'title'  => esc_html_x( 'Cite', 'Visual editor format label for HTML CITE tag used to set the blockquote source.', 'glamour' ),
											'inline' => 'cite',
										),
