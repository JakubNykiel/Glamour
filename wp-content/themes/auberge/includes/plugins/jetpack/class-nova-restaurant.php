				...
				// Output
					...
					<tr class="no-items menu-label-row" data-term_id="<?php echo esc_attr( $term->term_id ) ?>">
						...
						<td class="colspanchange" colspan="<?php echo (int) $non_order_column_count; ?>">
							<h3><?php
								...
								if ( ! is_wp_error( $term ) ) {
									...
									edit_term_link( esc_html__( 'edit', 'glamour' ), '<span class="edit-nova-section"><span class="dashicon dashicon-edit"></span>', '</span>', $term );

								} else {

									esc_html_e( 'Uncategorized' , 'glamour' );
						...
						<td>
							...
							<a class="nova-move-menu-up" title="<?php esc_attr_e( 'Move menu section up', 'glamour' ); ?>" href="<?php echo esc_url( $up_url ); ?>"><?php esc_html_e( 'UP', 'glamour' ); ?></a><br>
							<a class="nova-move-menu-down" title="<?php esc_attr_e( 'Move menu section down', 'glamour' ); ?>" href="<?php echo esc_url( $down_url ); ?>"><?php esc_html_e( 'DOWN', 'glamour' ); ?></a>
							<?php endif; ?>
						</td>
