				...
				$options = array(
					...
					// Theme credits
						...
						'001' . 'placeholder' => array(
							...
							'type'                 => 'section',
							'create_section'       => '',
							'in_panel'             => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
							'in_panel-description' => '<h3>' . esc_html__( 'Theme Credits', 'glamour' ) . '</h3>'
								. '<p class="description">'
								. sprintf(
									esc_html_x( '%1$s is a WordPress theme developed by %2$s.', '1: linked theme name, 2: theme author name.', 'glamour' ),
								...
								. '<p class="description">'
								. sprintf(
									esc_html_x( 'You can obtain other professional WordPress themes at %s.', '%s: theme author link.', 'glamour' ),
									'<strong><a href="http://www.webmandesign.eu" target="_blank">WebManDesign.eu</a></strong>'
								)
								. '</p>'
								. '<p class="description">'
								. esc_html__( 'Thank you for using this awesome theme!', 'glamour' )
								. '</p>',
						),
					...
					// Colors
						...
						100 . 'colors' . 10 => array(
							'id'             => 'colors-accents',
							'type'           => 'section',
							'create_section' => sprintf( esc_html_x( 'Colors: %s', '%s = section name. Customizer section title.', 'glamour' ), esc_html_x( 'Accents', 'Customizer color section title', 'glamour' ) ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),
							...
							100 . 'colors' . 10 . 100 => array(
								'type'        => 'color',
								'id'          => 'color' . '-accent',
								'label'       => esc_html__( 'Accent color', 'glamour' ),
								'description' => esc_html__( 'This color affects links, buttons and other elements of the website', 'glamour' ),
								'default'     => '#0aac8e',
							),
							100 . 'colors' . 10 . 110 => array(
								'type'        => 'color',
								'id'          => 'color' . '-accent-text',
								'label'       => esc_html__( 'Accent text color', 'glamour' ),
								'description' => esc_html__( 'Color of text over accent color background', 'glamour' ),
								'default'     => '#ffffff',
							),
						...
						100 . 'colors' . 20 => array(
							'id'             => 'colors-header',
							'type'           => 'section',
							'create_section' => sprintf( esc_html_x( 'Colors: %s', '%s = section name. Customizer section title.', 'glamour' ), esc_html_x( 'Header', 'Customizer color section title', 'glamour' ) ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),
							...
							100 . 'colors' . 20 . 100 => array(
								'type'       => 'color',
								'id'         => 'color' . '-header',
								'label'      => esc_html__( 'Background color', 'glamour' ),
								'default'    => '#1a1c1e',
								'preview_js' => array(
										'css' => array(
												'.site-header' => array(
							...
							100 . 'colors' . 20 . 110 => array(
								...
								'label'       => esc_html__( 'Text color', 'glamour' ),
								'description' => esc_html__( 'Note that for certain header elements the color will be faded out a bit', 'glamour' ),
								'default'     => '#ffffff',
								'preview_js'  => array(
										'css' => array(
												'.site-header' => array(
						...
						100 . 'colors' . 30 => array(
							'id'             => 'colors-content',
							'type'           => 'section',
							'create_section' => sprintf( esc_html_x( 'Colors: %s', '%s = section name. Customizer section title.', 'glamour' ), esc_html_x( 'Content', 'Customizer color section title', 'glamour' ) ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),

							100 . 'colors' . 30 . 200 => array(
								'type'    => 'html',
								'content' => '<h3>' . esc_html__( 'Front page widgets', 'glamour' ) . '</h3>',
							),
						...
						100 . 'colors' . 90 => array(
							'id'             => 'colors-footer',
							'type'           => 'section',
							'create_section' => sprintf( esc_html_x( 'Colors: %s', '%s = section name. Customizer section title.', 'glamour' ), esc_html_x( 'Footer', 'Customizer color section title', 'glamour' ) ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),
					...
					// Layout
						...
						200 . 'layout' => array(
							'id'             => 'layout',
							'type'           => 'section',
							'create_section' => esc_html_x( 'Layout', 'Customizer section title.', 'glamour' ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),

							200 . 'layout' . 100 => array(
								'type'    => 'html',
								'content' => '<h3>' . esc_html__( 'Front page layout', 'glamour' ) . '</h3>',
							),
								200 . 'layout' . 110 => array(
									'type'        => 'select',
									'id'          => 'layout' . '-blog-condensed',
									'label'       => esc_html__( 'Condensed blog posts', 'glamour' ),
									'description' => esc_html__( 'Select if and where to display this page section', 'glamour' ),
									'default'     => 'top|10',
									'options'     => array(
											'-'         => esc_html__( 'Disable section', 'glamour' ),
											'top|10'    => esc_html__( 'First section above page content', 'glamour' ),
											'top|20'    => esc_html__( 'Second section above page content', 'glamour' ),
											'bottom|10' => esc_html__( 'First section below page content', 'glamour' ),
											'bottom|20' => esc_html__( 'Second section below page content', 'glamour' ),
										),
								),
								200 . 'layout' . 120 => array(
									'type'        => 'select',
									'id'          => 'layout' . '-food-menu',
									'label'       => esc_html__( 'Food menu', 'glamour' ),
									'description' => esc_html__( 'Select if and where to display this page section', 'glamour' ),
									'default'     => 'bottom|10',
									'options'     => array(
											'-'         => esc_html__( 'Disable section', 'glamour' ),
					...
					// Typography
						...
						900 . 'typography' => array(
							'id'             => 'fonts',
							'type'           => 'section',
							'create_section' => esc_html_x( 'Typography', 'Customizer section title.', 'glamour' ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),

							900 . 'typography' . 100 => array(
								'type'    => 'html',
								'content' => '<p class="description">' . esc_html__( 'Set a Google Font to be used for website logo, headings and general text.', 'glamour' ) . '<br />' . sprintf( esc_html_x( 'Font matches recommendations from %s.', '%s: linked source website name.', 'glamour' ), '<a href="http://femmebot.github.io/google-type/" target="_blank">Google Web Fonts Typographic Project</a>' ) . '</p>',
							),

								900 . 'typography' . 110 => array(
									'type'    => 'select',
									'id'      => 'font' . '-family-logo',
									'label'   => esc_html__( 'Logo (site title) font', 'glamour' ),
								...
								900 . 'typography' . 120 => array(
									...
									'label'   => esc_html__( 'Headings font', 'glamour' ),
									'options' => wm_helper_var( 'google-fonts' ),
									'default' => 'Ubuntu:400,300',
								),
								900 . 'typography' . 130 => array(
									'type'    => 'select',
									'id'      => 'font' . '-family-body',
									'label'   => esc_html__( 'General text font', 'glamour' ),
									'options' => wm_helper_var( 'google-fonts' ),
									'default' => 'Ubuntu:400,300',
								),
								...
								900 . 'typography' . 140 => array(
									'type'    => 'multiselect',
									'id'      => 'font' . '-subset',
									'label'   => esc_html__( 'Font subset', 'glamour' ),
								...
								900 . 'typography' . 150 => array(
									'type'        => 'number',
									'id'          => 'font' . '-size-body',
									'label'       => esc_html__( 'Basic font size', 'glamour' ),
									'description' => esc_html__( 'All other font sizes are calculated automatically from this basic font size', 'glamour' ),
									'default'     => 16,
									'min'         => 12,
									'max'         => 24,
									'preview_js'  => array(
					...
					// Others
						...
						950 . 'others' => array(
							'id'             => 'others',
							'type'           => 'section',
							'create_section' => esc_html_x( 'Others', 'Customizer section title.', 'glamour' ),
							'in_panel'       => esc_html_x( 'Theme', 'Customizer panel title.', 'glamour' ),
						),
							...
							950 . 'others' . 100 => array(
								...
								'label'       => esc_html__( 'Show "Welcome" page', 'glamour' ),
								'description' => esc_html__( 'Under "Appearance" WordPress dashboard menu', 'glamour' ),
								'default'     => true,
							...
							950 . 'others' . 110 => array(
								...
								'label' => esc_html__( 'Disable excerpt on single post page', 'glamour' ),
							),
