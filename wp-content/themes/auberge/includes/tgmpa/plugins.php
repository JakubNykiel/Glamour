			...
			$plugins = apply_filters( 'wmhook_wm_plugins_suggestions-plugins', array(
					 ...
					 */
						...
						// Recommended
							...
							'jetpack' => array(
								'name'     => esc_html__( 'Jetpack by WordPress.com (adds theme features)', 'glamour' ),
								'slug'     => 'jetpack',
								'required' => false,
							),

							'beaver-builder' => array(
								'name'        => esc_html__( 'Beaver Builder (easy page builder)', 'glamour' ),
							...
							'advanced-custom-fields' => array(
								'name'        => esc_html__( 'Advanced Custom Fields (easy page setup)', 'glamour' ),
							...
							'one-click-demo-import' => array(
								'name'     => esc_html__( 'One Click Demo Import (for installing theme demo content)', 'glamour' ),
