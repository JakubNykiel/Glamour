...
<div id="comments" class="comments-area">
	...
	<h2 id="comments-title" class="comments-title">
		...
		printf(
			esc_html( _nx( '1 comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'Comments list title.', 'glamour' ) ),
		...
		<a href="#respond" class="add-comment-link"><?php echo esc_html_x( 'Add yours &rarr;', 'Add new comment link text.', 'glamour' ); ?></a>
	</h2>
	...
	if ( have_comments() ) :
		...
		if (
			...
			<h3 class="comments-closed"><?php esc_html_e( 'Comments are closed. You can not add new comments.', 'glamour' ); ?></h3>
		...
		// Paginated comments
			...
			if (
				...
				<nav id="comment-nav-below" class="navigation comment-navigation" role="navigation" aria-labelledby="comment-nav-below-label">
					...
					<h2 class="screen-reader-text" id="comment-nav-below-label"><?php esc_html_e( 'Comment navigation', 'glamour' ); ?></h2>

					<div class="nav-links">

						<div class="nav-previous"><?php previous_comments_link( esc_html__( '&larr; Older comments', 'glamour' ) ); ?></div>
						<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer comments &rarr;', 'glamour' ) ); ?></div>
