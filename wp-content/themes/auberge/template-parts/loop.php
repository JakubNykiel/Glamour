...
// Helper variables
	...
	$glamour_list_type = ( is_archive() && is_tax( 'nova_menu' ) ) ? ( 'items' ) : ( 'posts' );
...
if ( have_posts() ) :
	...
	<div id="<?php echo esc_attr( $glamour_list_type ); ?>" class="<?php echo esc_attr( $glamour_list_type ); ?> <?php echo esc_attr( $glamour_list_type ); ?>-list clearfix"<?php echo wm_schema_org( 'ItemList' ); ?>>
