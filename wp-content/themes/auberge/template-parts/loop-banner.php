...
// Helper variables
	...
	$glamour_banner_container_class = ( is_front_page() && wm_has_banner_posts( 2 ) ) ? ( 'enable-slider' ) : ( 'no-slider' );

?>

<div id="site-banner" class="site-banner <?php echo esc_attr( $glamour_banner_container_class ) ?>"<?php do_action( 'wmhook_site_banner_container_atts' ); ?>>

	<aside class="site-banner-inner">

		<h2 class="screen-reader-text"><?php echo esc_attr__( 'Site banner', 'glamour' ); ?></h2>
