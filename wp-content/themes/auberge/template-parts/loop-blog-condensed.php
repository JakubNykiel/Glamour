 ...
 */
	...
	$glamour_blog_condensed = new WP_Query( apply_filters( 'wmhook_loop_blog_condensed_query', array(
			'post_type'           => 'post',
			'posts_per_page'      => 6,
			'paged'               => 1,
 ...
 * Loop
 */
if ( $glamour_blog_condensed->have_posts() ) :
	...
	<section class="blog-posts page-section">
		...
		<header class="page-header">
			...
			<h2 class="page-title"><?php
				...
				$title_blog_condensed = (string) apply_filters( 'wmhook_loop_blog_condensed_title_text', esc_html__( 'News', 'glamour' ) );

				if ( $glamour_page_for_posts_id = absint( get_option( 'page_for_posts' ) ) ) {

					echo (string) apply_filters( 'wmhook_loop_blog_condensed_title_text_html', '<a href="' . esc_url( get_permalink( $glamour_page_for_posts_id ) ) . '">' . $title_blog_condensed . '</a>' );
		...
		<div class="posts posts-list clearfix"<?php echo wm_schema_org( 'ItemList' ); ?>>
			...
			while ( $glamour_blog_condensed->have_posts() ) : $glamour_blog_condensed->the_post();
