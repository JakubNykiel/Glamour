...
<article role="article" id="post-<?php the_ID(); ?>" <?php post_class(); echo apply_filters( 'wmhook_entry_container_atts', '' ); ?>>
	...
	<div class="entry-content"<?php echo wm_schema_org( 'itemprop="description"' ); ?>>
		...
		<table>
			...
			<caption><?php echo esc_html_x( 'Image info', 'Attachment page image info table caption.', 'glamour' ); ?></caption>

			<tbody>

				<tr class="date">
					<th><?php echo esc_html_x( 'Image published on:', 'Attachment page publish time.', 'glamour' ); ?></th>
				...
				<tr class="size">
					<th><?php esc_html_e( 'Image size:', 'glamour' ); ?></th>
				...
				<tr class="filename">
					<th><?php esc_html_e( 'Image file name:', 'glamour' ); ?></th>
