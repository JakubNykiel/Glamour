...
<nav id="site-navigation" class="main-navigation" role="navigation" aria-labelledby="site-navigation-label"<?php echo wm_schema_org( 'SiteNavigationElement' ); ?>>
	...
	<h2 class="screen-reader-text" id="site-navigation-label"><?php esc_html_e( 'Primary Menu', 'glamour' ); ?></h2>
	...
	<button id="menu-toggle" class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><?php echo esc_html_x( 'Menu', 'Mobile navigation toggle button title.', 'glamour' ); ?></button>
