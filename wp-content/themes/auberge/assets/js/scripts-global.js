...
jQuery( function() {
	 ...
	 */
		 ...
		 */
		 	...
		 	var $glamourFoodMenuGroupHeaders = jQuery( '.items-list .menu-group-header' ).length;

			if ( 1 < $glamourFoodMenuGroupHeaders ) {
				...
				// Set class on items list
					...
					jQuery( '.items-list' )
						.addClass( 'menu-group-count-' + $glamourFoodMenuGroupHeaders );
		 ...
		 */
			...
			var $glamourRtbContact = jQuery( '.rtb-booking-form .contact' ).hide();
